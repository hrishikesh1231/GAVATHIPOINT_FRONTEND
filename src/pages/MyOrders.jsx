...
const FontStyle = () => (
  <style>{`
    ...
    .mo-page { padding-top: 72px; }
    @media (min-width: 640px) { .mo-page { padding-top: 80px; } }
    @media (min-width: 1024px) { .mo-page { padding-top: 88px; } }
  `}</style>
);
...
const MyOrders = () => {
  ...
  const filteredOrders = orders.filter((order) => {
    if (activeTab === "Pending")    return order.status === "Pending" || order.status === "Seller Responded";
    if (activeTab === "Preparing")  return order.deliveryStatus === "Preparing";
    if (activeTab === "On The Way") return order.deliveryStatus === "Out For Delivery";
    if (activeTab === "Delivered")  return order.deliveryStatus === "Delivered";
    return false;
  });
  ...
  return (
    <div className="mo mo-bg mo-page relative" style={{ paddingBottom:"clamp(60px,12vw,100px)" }}>
      <FontStyle/>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-8 pt-6">
                      ...
                      <>
                        ...
                        <div>
                          <div className="flex items-center gap-2 mb-3">
                            <div className="rounded-lg bg-green-50 flex items-center justify-center"
                              style={{ width:28, height:28, border:"1px solid rgba(45,106,53,0.14)" }}>
                          ...
                          <div className="space-y-3">
                            {Object.entries(order.sellerResponse || {}).map(([productId, response], index) => (
                              <div key={index} className="mo-response-card">
                                <div className="flex items-center justify-between gap-3">
                                  <div>
                                    ...
                                    <span className="inline-block mt-1.5 text-[#2d6a35] font-semibold"
                                  ...
                                  <div className="text-right flex-shrink-0">
                                    <p className="mo-serif font-black text-[#1a3d1f]"
                                      style={{ fontSize:"clamp(16px,4.5vw,22px)" }}>
                                      ₹{response.finalPrice}
                                    </p>
                                    <p className="text-[#a09070]" style={{ fontSize:10 }}>final price</p>
                                  </div>
                                </div>
                              </div>
                            ))}
